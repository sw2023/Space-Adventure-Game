...
def misc_events():
    ...
    if event_type == 1:
        ...
        print("The probe encounters an alien vessel.")
        sleep(4)
        print("The probe fruitlessly tries to scan the vessel, but its shields are far too strong to be")
        print("penetrated by the probe's comparatively weak sensors.")
        sleep(10)
        print("Although the aliens could easily obliterate the probe, they chose not to and instead")
        print("quietly observe it for a few moments.")
        sleep(9)
        print("Suddenly, the alien vessel warps away, leaving the probe behind.")
        sleep(6)
        print("The probe notes that aliens do, in fact, exist. It then speeds off into the void.")
        sleep(7)
        clear()